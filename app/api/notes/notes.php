 ...
 *
 * Función:
 * Recupera las notas de la base de datos ligadas al usuario
 */
...
// Ejecuta la operación de selección de las notas del usuario, si todo va bien
// devuelve un array asociativo con las notas
// si no devuelve un error
try {
    $db = Database::connect();
    $stm = $db->prepare('SELECT * FROM notes where user_id = ?');
